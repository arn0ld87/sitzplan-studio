# Designsystem — Sitzplan Studio

> [!IMPORTANT]
> Dieses Dokument ist die **Single Source of Truth** für Gestaltung und Oberfläche.
> Es ist fertig entworfen — nicht neu interpretieren, nicht „modernisieren".
> Abweichungen sind Bugs. Änderungen brauchen eine bewusste Entscheidung, keinen Refactor.

Sitzplan Studio ist eine Web-App für Lehrkräfte: Klassen verwalten, Räume zeichnen,
Sitzpläne erstellen. Die Oberfläche ist durchgängig deutschsprachig.

> [!NOTE]
> Der ursprüngliche Text sprach von einer „reinen Frontend-Demo ohne Backend".
> Das gilt nicht mehr: Die App persistiert seit `20260801085950` in Supabase
> (Postgres + Auth + Row Level Security). Die gestalterischen Vorgaben unten
